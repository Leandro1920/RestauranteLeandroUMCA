...
namespace sistemaRestaurante.controlador
{
    class controlOrden
    {
        ...
        public Boolean agregarOrden(int monto)
        {
        ...
        public Boolean agregarDetalleOrden(string nombreProducto)
        {
        ...
        public Boolean agregarOrdenTipoMesaLocal(mesa _mesa,clienteFrecuent _cliente,usuario _Personal)
        {
        ...
        public Boolean agregarOrdenParaLlevar(string observacion, clienteFrecuent _cliente, usuario _Personal)
        {

...
namespace sistemaRestaurante.vistas
{
    public partial class mesas : Form
    {
        ...
        private void mesas_Load(object sender, EventArgs e)
        {
            ...
            btncolor1.BackColor = Color.LawnGreen;
            btncolor2.BackColor = Color.Red;
            btnColor3.BackColor = Color.Beige;
        ...
        public void pintarMesas()
        {
            ...
            {
                m8.BackColor = Color.Beige;
                reservadas++;
            }
            //mesa 9
            if (arraymesas[8] == "libre")
            {
                m9.BackColor = Color.LawnGreen;
                libres++;
            }
            ...
            {
                m10.BackColor = Color.Beige;
                reservadas++;
            }
            //mesa 11
            if (arraymesas[10] == "libre")
            {
                m11.BackColor = Color.LawnGreen;
                libres++;
            }
        ...
        {
            txtFechaReservacion.Text = calendario.SelectionStart.ToString(); 
        }
        ...
        private void txtTotalMesas_TextChanged(object sender, EventArgs e)
        {

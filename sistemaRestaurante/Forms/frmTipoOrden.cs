...
{
    public partial class frmTipoOrden : Form
    {
        public frmTipoOrden()
        {
            InitializeComponent();
        ...
        private void btnListo_Click(object sender, EventArgs e)
        {
            ...
            _clF.Respuesta = _controlOrden.agregarOrdenTipoMesaLocal(_mesa, _clF, _usuario);
        ...
        private void btnListo2_Click(object sender, EventArgs e)
        {
            ...
            _clF.Respuesta = _controlOrden.agregarOrdenParaLlevar(txtDescricion.Text, _clF, _usuario);
            if (_clF.Respuesta == true)
            {
                lblRespuesta.Text = "La orden Se ha registrado";
            }
